...
export default async function Home() {
  ...
  return (
    <>
      ...
      <footer className="footer"><div className="footer-inner"><Brand className="footer-brand" logoUrl={logoUrl} /><p>{footer.Contenu || "Contenus pédagogiques et informatifs. Le Hibou Rusé n’est pas un CGP et ne fournit pas de conseil juridique, fiscal ou financier individualisé réglementé."}</p><div><a href="/mentions-legales">Mentions légales</a><a href="/confidentialite">Confidentialité</a><a href="/conditions-utilisation">Conditions d’utilisation</a></div></div></footer>
