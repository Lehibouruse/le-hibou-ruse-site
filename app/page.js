  ...
  return (
    <>
      ...
      <main id="top">
        ...
        <section className="services" id="services"><div className="services-inner"><div className="services-copy"><div className="eyebrow dark"><span /> Services proposés</div><h2>{strategy.Titre || "Montages à explorer & montage atypique"}</h2><p>Deux formats pour aller plus loin que le guide : repérer les montages du Hibou qui pourraient mériter d’être explorés dans votre situation, ou creuser un montage précis.</p><div className="service-cards"><article><span>01</span><h3>Montages à explorer</h3><strong>500 €</strong><p>À partir des éléments que vous nous donnez, le Hibou repère parmi ses montages ceux qui semblent les plus pertinents à explorer dans votre situation, puis en explique le mécanisme, les conditions, les limites et les risques.</p></article><article><span>02</span><h3>Montage atypique spécifique</h3><strong>Sur devis</strong><p>Vous avez déjà une idée ou un montage précis en tête ? Le Hibou l’analyse, en détaille le fonctionnement, les points de vigilance et les questions à vérifier avant d’aller plus loin.</p></article></div><div className="notice"><strong>Le cadre est clair.</strong> Le Hibou Rusé n’est pas un CGP et ne fournit pas de conseil juridique, fiscal ou financier individualisé réglementé. Il propose des contenus et analyses pédagogiques ; une validation professionnelle reste nécessaire lorsqu’elle est requise.</div></div><div><div className="form-heading"><span>Écrire au Hibou</span><h3>Exposez votre situation.</h3><p>Plus vous êtes précis, plus le Hibou pourra repérer les pistes pertinentes à explorer.</p></div><LeadForm /></div></div></section>
      </main>

      <footer className="footer"><div className="footer-inner"><Brand className="footer-brand" logoUrl={logoUrl} /><p>{footer.Contenu || "Contenus pédagogiques et informatifs. Le Hibou Rusé n’est pas un CGP et ne fournit pas de conseil juridique, fiscal ou financier individualisé réglementé."}</p><div><a href="/mentions-legales">Mentions légales</a><a href="/cgv">CGV</a><a href="/confidentialite">Confidentialité</a><a href="/conditions-utilisation">Conditions d’utilisation</a><a href="/retractation">Renoncer au contrat ici</a></div></div></footer>
