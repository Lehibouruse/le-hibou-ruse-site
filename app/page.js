  ...
  return (
    <>
      ...
      <main id="top">
        ...
        <section className="services" id="services"><div className="services-inner"><div className="services-copy"><div className="eyebrow dark"><span /> Services proposés</div><h2>{strategy.Titre || "Bilan personnel & montage atypique"}</h2><p>Deux formats pour aller plus loin que le guide, sans transformer Le Hibou Rusé en cabinet de conseil réglementé.</p><div className="service-cards"><article><span>01</span><h3>Bilan personnel</h3><strong>500 €</strong><p>Une analyse pédagogique structurée de votre situation, de vos revenus, de votre patrimoine et de vos objectifs, avec des pistes et scénarios à étudier.</p></article><article><span>02</span><h3>Montage atypique spécifique</h3><strong>Sur devis</strong><p>Exposez toute votre situation, avec le plus de détails possible. Le Hibou vous dira honnêtement ce qu’il peut réellement vous apporter, les pistes envisageables et le prix d’un travail approfondi.</p></article></div><div className="notice"><strong>Le cadre est clair.</strong> Le Hibou Rusé n’est pas un CGP et ne fournit pas de conseil juridique, fiscal ou financier individualisé réglementé. Il propose des contenus et analyses pédagogiques ; une validation professionnelle reste nécessaire lorsqu’elle est requise.</div></div><div><div className="form-heading"><span>Écrire au Hibou</span><h3>Exposez votre situation.</h3><p>Plus vous êtes précis, plus la réponse pourra être utile et honnête.</p></div><LeadForm /></div></div></section>
      </main>

      <footer className="footer"><div className="footer-inner"><Brand className="footer-brand" logoUrl={logoUrl} /><p>{footer.Contenu || "Contenus pédagogiques et informatifs. Le Hibou Rusé n’est pas un CGP et ne fournit pas de conseil juridique, fiscal ou financier individualisé réglementé."}</p><div><a href="/mentions-legales">Mentions légales</a><a href="/cgv">CGV</a><a href="/confidentialite">Confidentialité</a><a href="/conditions-utilisation">Conditions d’utilisation</a></div></div></footer>
