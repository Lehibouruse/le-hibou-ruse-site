...
export function workerInstructions(action) {
  ...
  return action === "CREATE_VIDEO"
    ...
    : `${common}\nUPDATE_SITE est ici une mission globale: parameters.key n'est pas requis. Lis le contexte Airtable et le dépôt, puis améliore le site sur une branche dédiée sans fusion automatique.`;
}
