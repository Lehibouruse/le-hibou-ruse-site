...
const VIDEO_TOOLS = [
  ...
  fn("run_tests", "Exécuter les tests du dépôt."),
  fn("run_build", "Exécuter le build de production."),
  fn("register_video_draft", "Pousser l'artefact sur une branche dédiée et enregistrer son lien dans la fiche Content Pipeline. Force l'attente humaine et interdit la publication.", {
