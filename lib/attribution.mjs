export const ATTRIBUTION_STORAGE_KEY = "hibou_attribution_v1";
export const PUBLIC_SITE_URL = "https://le-hibou-ruse-site.vercel.app";
...
export function captureAttribution({ search = "", href = "", referrer = "", previous = {} } = {}) {
  ...
  if (!next.landing_page && href) {
    try {
      const url = new URL(href, PUBLIC_SITE_URL);
