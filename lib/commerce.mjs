...
export function digifyRecipientRequest(context, env = process.env) {
  const url = safeDigifyUrl(env.DIGIFY_ADD_RECIPIENT_URL);
  if (!url) throw new Error("DIGIFY_ADD_RECIPIENT_URL absent: renseigner l'endpoint officiel Digify d'ajout destinataire du Developer Portal");
  return {
    url,
