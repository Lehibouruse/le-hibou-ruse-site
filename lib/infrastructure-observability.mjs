...
export function systemHealthConfigValues(snapshot = {}, circuit = {}, checkedAt = new Date().toISOString()) {
...
export function healthConfigDescriptions() {
  return {
    ...
    system_health_report: "Snapshot compact non sensible du Core : compteurs, codes d'incident, circuit OpenAI et readiness. Aucun token ni secret.",
  };
}
