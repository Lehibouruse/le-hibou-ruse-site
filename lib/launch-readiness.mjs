...
export function commercialReadiness({ config = {}, product = {}, chapters = [], legal = [], env = process.env } = {}) {
  ...
  add("live_checkout_verified", Boolean(text(config.lemon_live_checkout_id)) && text(config.lemon_checkout_status) === "LIVE_PUBLIC", "Checkout Lemon live personnalisé et version partielle annoncée");
