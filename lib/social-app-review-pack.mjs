...
const PROVIDERS = {
  reddit: {
    ...
    permissions: "identity verifies the owned account, read retrieves public metadata for the project’s own posts, and submit publishes original text or links only after approval and human review.",
