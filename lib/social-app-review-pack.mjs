...
const PROVIDERS = {
  reddit: {
    label: "Reddit",
    use_case: "Commercial editorial account management for Le Hibou Rusé: authenticate its own account and publish original text or links to selected communities where permitted. No Reddit API traffic before written approval.",
    permissions: "identity verifies the account, read supports reading public post metadata, and submit publishes original text or links. Permanent OAuth is requested only to refresh the account token without repeated sign-in.",
    validation: "Offline tests and dry runs are available. A live publication requires explicit approval and a configured target subreddit. No paid API agreement is accepted automatically.",
  },
  youtube: {
    label: "YouTube",
