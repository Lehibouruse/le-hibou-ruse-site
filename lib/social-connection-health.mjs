...
const SUPPORTED_NETWORKS = ["youtube", "instagram", "facebook", "tiktok", "linkedin", "threads", "pinterest", "x", "bluesky"];
...
function platformLabel(network) {
  return ({
    ...
    linkedin: "LinkedIn", threads: "Threads", pinterest: "Pinterest", x: "X", bluesky: "Bluesky",
  })[network] || network;
}
