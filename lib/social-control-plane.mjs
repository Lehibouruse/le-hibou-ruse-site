...
const PROVIDERS = {
  reddit: {
    ...
    externalBlocker: "Obtenir l’accord Reddit pour l’usage commercial avant toute activation OAuth ou publication. REDDIT_API_APPROVED doit rester faux ou absent tant que cet accord n’est pas obtenu.",
    sessionStep: "Demande Reddit → accord → app Web OAuth + callback → Client ID/Secret et User-Agent côté serveur → OAuth du compte Hibou → test lecture → choix d’un subreddit compatible avant toute publication.",
  },
  youtube: {
    label: "YouTube",
