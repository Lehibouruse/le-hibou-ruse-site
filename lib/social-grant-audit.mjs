const REQUIREMENTS = {
  reddit: {
    ...
    publish_all: ["submit"],
    analytics_all: ["read"],
    blocker: "Accord Reddit pour l’usage commercial + app OAuth Web. Le connecteur doit rester fail-closed tant que REDDIT_API_APPROVED=true n’a pas été enregistré après accord.",
  },
  youtube: {
    label: "YouTube",
