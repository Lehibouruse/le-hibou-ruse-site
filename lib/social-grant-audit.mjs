const REQUIREMENTS = {
  reddit: {
    label: "Reddit", publish_all: ["submit"], analytics_all: ["identity", "read"],
    blocker: "Autorisation API commerciale Reddit, application Web OAuth et consentement du compte Hibou requis. Lecture de l’identité et publications texte/lien ; pas de vidéo native ni de métriques de vues garanties.",
  },
  youtube: {
    label: "YouTube",
