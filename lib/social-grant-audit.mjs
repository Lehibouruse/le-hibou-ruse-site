const REQUIREMENTS = {
  youtube: {
    ...
    blocker: "Client OAuth Web + YouTube Data API v3 + consentement du propriétaire de la chaîne.",
  },
  meta: {
    label: "Meta · Facebook + Instagram",
    publish_all: ["pages_manage_posts", "instagram_content_publish"],
    analytics_all: ["pages_read_engagement"],
    blocker: "App Meta, Page Facebook reliée au compte Instagram professionnel et permissions/app review applicables.",
  },
  tiktok: {
    label: "TikTok",
...
export function auditSocialGrants(readiness = [], credentials = []) {
  ...
  return Object.entries(REQUIREMENTS).map(([provider, requirement]) => {
...
export { REQUIREMENTS as SOCIAL_GRANT_REQUIREMENTS };
